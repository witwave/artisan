...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active">{{ Lang::get('menus.groups') }}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-controls text-right">
                ...
                @endif
                {!! HTML::link('admin/groups/create', Lang::get('buttons.create_new'), array('class' => 'btn btn-primary btn-sm')) !!}
            </div>
            </div>
        </div>
    </div>
	...
	@else
		<div class="alert alert-info">{{ Lang::get('messages.no_group_found') }}</div>
	@endif
@stop
