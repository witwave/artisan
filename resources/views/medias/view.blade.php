...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active">{{ Lang::get('menus.medias') }}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-controls text-right">
                ...
                @endif
                <a id="rd-media-get-all-duration" class="btn btn-default btn-sm">{{ Lang::get('buttons.get_durations') }}</a>
                {!! HTML::link('admin/medias/create', Lang::get('buttons.create_new'), array('class' => 'btn btn-primary btn-sm')) !!}
            </div>
            </div>
        </div>
    </div>
        ...
        <table class='table table-striped table-bordered table-condensed'>
            <thead>
                <tr>
                    ...
                    <th>{{ Lang::get('forms.media_file') }}</th>
                    <th>{{ Lang::get('forms.duration') }}</th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
    ...
    @else
        <div class="alert alert-info">{{ Lang::get('messages.no_media_found') }}</div>
    @endif
@stop
