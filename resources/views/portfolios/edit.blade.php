...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/portfolios') }}">{{ Lang::get('menus.portfolios') }}</a></li>
    ...
    {!! Form::open(array('files' => TRUE, 'action' => '\App\Http\Controllers\PortfolioController@postStore', 'role' => 'form')) !!}
    	...
    	<div class='row'>
            <div class="col-md-3 col-md-push-9">
                <div class="well">
                    <div class='form-actions'>
                        {!! HTML::link('admin/portfolios', Lang::get('buttons.cancel'), array('class' => 'btn btn-link btn-sm'))!!}
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label for="active-checker">
                                {!! Form::checkbox('active', $portfolio->active, $portfolio->active, array('id' => 'active-checker')) !!} {{ Lang::get('forms.active') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-9 col-md-pull-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">{{ Lang::get('forms.edit_portfolio') }}</h4>
                    </div>
                    <div class="panel-body">
