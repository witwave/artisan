...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active">{{ Lang::get('menus.mailinglist') }}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-controls text-right">
                ...
                {!! HTML::link('admin/mailinglists/create', Lang::get('buttons.create_new'), array('class' => 'btn btn-primary btn-sm')) !!}
            </div>
            </div>
        </div>
    </div>
    ...
    @else
        <div class="alert alert-info">{{ Lang::get('messages.no_mailinglist_found') }}</div>
    @endif
    <div id="export-csv" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(array('action' => '\App\Http\Controllers\ReportController@postMailinglist', 'report' => 'form')) !!}
