...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active">{{ Lang::get('menus.bundles') }}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-controls text-right">
                ...
                @endif
                {!! HTML::link('admin/bundles/create', Lang::get('buttons.create_new'), array('class' => 'btn btn-primary btn-sm')) !!}
            </div>
            </div>
        </div>
    </div>
        ...
        <table class='table table-striped table-bordered table-condensed'>
            <thead>
                <tr>
                    ...
                    <th>{{ Lang::get('forms.total_value') }}</th>
    ...
    @else
        <div class="alert alert-info">{{ Lang::get('messages.no_bundle_found') }}</div>
    @endif
@stop
