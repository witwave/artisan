...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/posts') }}">{{ Lang::get('menus.posts') }}</a></li>
    ...
    {!! Form::open(array('files' => TRUE, 'action' => '\App\Http\Controllers\PostController@postStore', 'role' => 'form')) !!}
    	...
    	<div class='row'>
            <div class="col-md-3 col-md-push-9">
                <div class="well">
                    <div class='form-actions'>
                        {!! HTML::link('admin/posts', Lang::get('buttons.cancel'), array('class' => 'btn btn-link btn-sm'))!!}
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label for="featured-checker">
                                {!! Form::checkbox('featured', $post->featured, $post->featured, array('id' => 'featured-checker')) !!} {{ Lang::get('forms.featured') }}
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label for="private-checker">
                                {!! Form::checkbox('private', $post->private, $post->private, array('id' => 'private-checker')) !!} {{ Lang::get('forms.private') }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-9 col-md-pull-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">{{ Lang::get('forms.edit_post') }}</h4>
                    </div>
                    <div class="panel-body">
