...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active">{{ Lang::get('menus.coupons') }}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-controls text-right">
                ...
                @endif
                {!! HTML::link('admin/coupons/create', Lang::get('buttons.create_new'), array('class' => 'btn btn-primary btn-sm')) !!}
            </div>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <th>
                        <a href="{{ URL::to('admin/coupons/sort') . '/usage_limit_per_coupon/' . ($sortBy == 'usage_limit_per_coupon' && $orderBy == 'asc' ? 'desc' : 'asc') }}">
                            {{ Lang::get('forms.usage_limit_per_coupon') }}
                    ...
                    <th>
                        <a href="{{ URL::to('admin/coupons/sort') . '/usage_limit_per_user/' . ($sortBy == 'usage_limit_per_user' && $orderBy == 'asc' ? 'desc' : 'asc') }}">
                            {{ Lang::get('forms.usage_limit_per_user') }}
    ...
    @else
        <div class="alert alert-info">{{ Lang::get('messages.no_coupon_found') }}</div>
    @endif
@stop
